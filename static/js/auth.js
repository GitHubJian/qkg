...
if (!window['QSSO']) {
    var QSSO = (function() {
        ...
        if (location.hostname.match(/qunar\.ctripgroup\.c(om|n)$/i)) {
            ...
            auth: function(loginURI, opt_ext) {
                if (
                    !location.hostname.match(
                        /\.qunar(man|ops)?\.com$|qunar\.it$|\.928383\.com$|^928383\.com$|qunar\.ctripgroup\.com$|\.ctrip(corp)?\.com$|^opsdata\.me$|\.mofun\.com$/i
                    )
                ) {
                    location =
                        AUTH_SERVER +
                ...
                var redirectURL =
                    ...
                    ret +
                    (opt_ext
                        ? '&ext=' + encodeURIComponent(URLStringify(opt_ext))
                        : '');
